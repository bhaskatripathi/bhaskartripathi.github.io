...
const apiKey = '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'; // Your OpenAI API Key
const stop = '';
const url = `https://api.openai.com/v1/completions`;
let prompt = [
  `You are a web chat bot inside of the website: https://www.wikipedia.org/`,
  ``,
